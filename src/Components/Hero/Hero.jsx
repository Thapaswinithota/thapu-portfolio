...
const Hero = () => {
  return (
    <div id='home' className='hero'>
        ...
        <h1>Welcome to my <em>Portfolio</em></h1>
        ...
        <div className="hero-action">
            ...
            <div className="hero-resume">
                <a href='https://drive.google.com/file/d/1zhHP93C27UxTuNgoYUcBUpECRvSdlwgD/view?usp=sharing' target='_blank' rel='noopener noreferrer'>My Resume</a>
            </div>
        </div>
